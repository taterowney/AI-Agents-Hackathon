...
vllm serve deepseek-ai/DeepSeek-R1-Distill-Qwen-14B --port 8000 --max_model_len 50000 --tensor-parallel-size 2 --enable-reasoning --reasoning-parser deepseek_r1 &
